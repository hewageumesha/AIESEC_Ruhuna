...
const AddBirthday = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ firstName: "", birthday: "", role: "", email: "", profilePicture: "" });
  ...
  return (
   <div className="min-h-screen bg-white dark:from-gray-900 dark:to-gray-800 flex flex-col items-center justify-start py-10 px-4">
      ...
      >
        ...
        {["userId", "name", "birthday", "profilePicture"].map((field) => (
  <div className="mb-4" key={field}>
    <label htmlFor={field} className="block font-medium mb-2 text-white dark:text-gray-200">
