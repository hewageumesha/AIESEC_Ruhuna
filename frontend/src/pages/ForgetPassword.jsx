...
export default function ForgotPassword() {
  ...
  const handleSendCode = async (e) => {
    ...
    try {
      const res = await fetch(`https://aiesecinruhuna-production.up.railway.app/forgot-password/verifyMail/${email}`, {
        method: 'POST',
  ...
  const handleVerifyCode = async (e) => {
    ...
    try {
      const res = await fetch(`https://aiesecinruhuna-production.up.railway.app/forgot-password/verifyOtp/${code}/${email}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://aiesecinruhuna-production.up.railway.app/forgot-password/changePassword/${email}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
