...
const EditEvent = () => {
      ...
      try {
        ...
        if (data) {
          ...
          if (data.hasMerchandise) {
            try {
              const merchResponse = await axios.get(`https://aiesecruhuna-production.up.railway.app/api/merchandise/event/${id}`);
  ...
  const onFinish = async (values) => {
    try {
      ...
      try {
        await axios.delete(`https://aiesecruhuna-production.up.railway.app/api/merchandise/event/${id}`);
      } catch (error) {
