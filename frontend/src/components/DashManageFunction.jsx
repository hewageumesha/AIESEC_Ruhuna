...
export default function DashManageFunction() {
  ...
  const handleSubmit = async () => {
    try {
      if (editingId) {
        await axios.put(`https://aiesecruhuna-production.up.railway.app/api/functions/update/${editingId}`, formData);
        setSuccessMsg("Function updated successfully!");
      } else {
        await axios.post("https://aiesecruhuna-production.up.railway.app/api/functions/add", formData);
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://aiesecruhuna-production.up.railway.app/api/functions/delete/${deleteId}`);
