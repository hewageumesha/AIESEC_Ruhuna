...
export default function DashManageFunction() {
  ...
  const handleSubmit = async () => {
    try {
      if (editingId) {
        await axios.put(`https://aiesec-ruhuna.vercel.app/api/functions/update/${editingId}`, formData);
        setSuccessMsg("Function updated successfully!");
      } else {
        await axios.post("https://aiesec-ruhuna.vercel.app/api/functions/add", formData);
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://aiesec-ruhuna.vercel.app/api/functions/delete/${deleteId}`);
