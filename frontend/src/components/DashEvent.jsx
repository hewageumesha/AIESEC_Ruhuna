...
const DashEvent = () => {
  ...
  const fetchFilteredEvents = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://aiesecruhuna-production.up.railway.app/api/events/filter', {
        params,
      });
  ...
  const handleDelete = async (eventId, e) => {
    e.stopPropagation();
    try {
      await axios.delete(`https://aiesecruhuna-production.up.railway.app/api/events/${eventId}`);
