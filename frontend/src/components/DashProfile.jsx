    ...
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <TextInput
          ...
          defaultValue={currentUser.focusProduct}
          onChange={handleChange}
        />
        <TextInput
          type='date'
          id='startDate'
          defaultValue={currentUser.startDate}
          onChange={handleChange}
        />
        <TextInput
          type='date'
          id='endDate'
          defaultValue={currentUser.endDate}
          onChange={handleChange}
        />
        <TextInput
          type='text'
          ...
          defaultValue={currentUser.duration}
          onChange={handleChange}
        />
        <TextInput
          type='text'
          id='timeline'
          placeholder='Timeline (Active/Not Active)'
          defaultValue={currentUser.timeline}
          onChange={handleChange}
        />
        <Button
          type='submit'
