        ...
        const fetchUserDetails = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    setFirstName(userDetails.firstName); // fixed typo
            ...
            <div className="flex-1 p-10 transition-colors duration-300">
                <div className="max-w-6xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg transition-colors duration-300">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button
                            className="bg-blue-500 text-white px-6 py-3 rounded-lg flex items-center hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 transition-colors duration-200"
                            onClick={handleCreateTask}
                        >
                    ...
                    <div className="mt-6 space-y-4">
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                className="bg-gray-500 text-white px-6 py-3 rounded hover:bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-500 transition-colors duration-200"
                                onClick={handleShowAllTasks}
                            >
                                Show All Tasks
                            </button>
