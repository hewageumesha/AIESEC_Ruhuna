...
class SplitterControl extends _ui.default {
    ...
    _initMarkup() {
        ...
        this._$splitterBorder = (0, _renderer.default)("<div>").addClass("dx-splitter-border").appendTo(this.$element());
        this._$splitter = (0, _renderer.default)("<div>").addClass(SPLITTER_CLASS).addClass("dx-splitter-inactive").appendTo(this._$splitterBorder)
    }
    _initActions() {
        this._actions = {
