...
class GanttView extends _ui.default {
    ...
    _initMarkup() {
        ...
        const visualState = this.option("visualState");
        if (visualState) {
    ...
    updateView() {
        ...
        null === (_this$_ganttViewCore = this._ganttViewCore) || void 0 === _this$_ganttViewCore || _this$_ganttViewCore.updateView()
    }
    updateBarItemsState() {
    ...
    _update(keepExpandState) {
        ...
        null === (_this$_ganttViewCore2 = this._ganttViewCore) || void 0 === _this$_ganttViewCore2 || _this$_ganttViewCore2.updateWithDataReload(keepExpandState)
    }
    _getCultureInfo() {
        return {
    ...
    applyTasksExpandedState(state) {
        ...
        null === (_this$_ganttViewCore3 = this._ganttViewCore) || void 0 === _this$_ganttViewCore3 || _this$_ganttViewCore3.applyTasksExpandedState(state)
    }
    getVisualStateToRestore() {
        var _this$_ganttViewCore4, _this$_ganttViewCore5;
        return {
            [fullScreenModeKey]: null === (_this$_ganttViewCore4 = this._ganttViewCore) || void 0 === _this$_ganttViewCore4 || null === (_this$_ganttViewCore5 = _this$_ganttViewCore4.isInFullScreenMode) || void 0 === _this$_ganttViewCore5 ? void 0 : _this$_ganttViewCore5.call(_this$_ganttViewCore4)
        }
    }
}
