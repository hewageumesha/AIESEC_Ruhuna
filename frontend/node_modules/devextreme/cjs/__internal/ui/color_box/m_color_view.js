/**
 * DevExtreme (cjs/__internal/ui/color_box/m_color_view.js)
 * Version: 24.2.8
...
class ColorView extends _editor.default {
    _supportedKeys() {
    ...
    _renderRgbInputs() {
        this._rgbInputsWithLabels = [this._renderEditorWithLabel({
            editorType: _m_number_box.default,
    ...
    _renderEditorWithLabel(options) {
        ...
        if (editorType === _m_number_box.default) {
    ...
    hexInputOptions() {
        return {
            editorType: _m_text_box.default,
    ...
    _renderHexInput() {
        this._hexInput = _m_text_box.default.getInstance(this._renderEditorWithLabel(this.hexInputOptions()).appendTo(this._$controlsContainer).find(".dx-textbox"));
