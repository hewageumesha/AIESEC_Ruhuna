...
class MessageBox extends _dom_component.default {
    ...
    _initMarkup() {
        (0, _renderer.default)(this.element()).addClass("dx-chat-messagebox");
        super._initMarkup();
    ...
    _renderTextArea() {
        ...
        const $textArea = (0, _renderer.default)("<div>").addClass("dx-chat-messagebox-textarea").appendTo(this.element());
    ...
    _renderButton() {
        ...
        const $button = (0, _renderer.default)("<div>").addClass("dx-chat-messagebox-button").appendTo(this.element());
