...
class AlertList extends _widget.default {
    ...
    _renderItem(itemData) {
        ...
        (0, _renderer.default)("<div>").addClass("dx-chat-alertlist-error-icon").appendTo($item);
        (0, _renderer.default)("<div>").addClass("dx-chat-alertlist-error-text").appendTo($item).text(String((null === itemData || void 0 === itemData ? void 0 : itemData.message) ?? ""));
