/**
 * DevExtreme (cjs/__internal/ui/map/m_provider.dynamic.bing.js)
 * Version: 24.2.8
...
let msMapsLoader;
class BingProvider extends _m_provider.default {
    _mapType(type) {
        const mapTypes = {
    ...
    _renderRoute(options) {
        return Promise.all((0, _iterator.map)(options.locations, (point => this._resolveLocation(point)))).then((locations => new Promise((resolve => {
            ...
            (0, _iterator.each)(locations, ((_, location) => {
...
var _default = exports.default = BingProvider;
