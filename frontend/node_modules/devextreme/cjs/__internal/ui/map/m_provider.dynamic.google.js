/**
 * DevExtreme (cjs/__internal/ui/map/m_provider.dynamic.google.js)
 * Version: 24.2.8
...
const googleMapsLoaded = function() {
    var _window$google;
    return null === (_window$google = window.google) || void 0 === _window$google ? void 0 : _window$google.maps
};
let googleMapsLoader;
class GoogleProvider extends _m_provider.default {
    _mapType(type) {
        const mapTypes = {
    ...
    _init() {
        return new Promise((resolve => {
            this._resolveLocation(this._option("center")).then((center => {
                ...
                const mapId = (null === providerConfig || void 0 === providerConfig ? void 0 : providerConfig.mapId) ?? "";
    ...
    isEventsCanceled(e) {
        var _this$_map;
        const gestureHandling = null === (_this$_map = this._map) || void 0 === _this$_map ? void 0 : _this$_map.get("gestureHandling");
        const isInfoWindowContent = (0, _renderer.default)(e.target).closest(".gm-style-iw").length > 0;
    ...
    _renderMarker(options) {
        return this._resolveLocation(options.location).then((location => {
            ...
            if (options.html) {
                ...
                const providerConfig = this._option("providerConfig");
                const useAdvancedMarkers = (null === providerConfig || void 0 === providerConfig ? void 0 : providerConfig.useAdvancedMarkers) ?? true;
                const icon = options.iconSrc || this._option("markerIconSrc");
                if (useAdvancedMarkers) {
                    const content = icon ? this._createIconTemplate(icon) : void 0;
