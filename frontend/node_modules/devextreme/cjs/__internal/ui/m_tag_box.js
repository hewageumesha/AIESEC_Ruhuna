...
class TagBox extends _m_select_box.default {
    _supportedKeys() {
        ...
        return _extends({}, parent, {
            ...
            enter(e, options) {
                var _this$_list;
                const isListItemFocused = null !== (null === (_this$_list = this._list) || void 0 === _this$_list ? void 0 : _this$_list.option("focusedElement")) && true === this.option("opened");
    ...
    _renderTagRemoveAction() {
        ...
        _events_engine.default.on(this._$tagsContainer, eventName, ".dx-tag-remove-button", (event => {
            tagRemoveAction({
                event: event
            })
        }))
    ...
    _renderMultiTag($input) {
        ...
        const $tag = (0, _renderer.default)("<div>").attr("id", tagId).addClass("dx-tag").addClass("dx-tagbox-multi-tag");
        const args = {
    ...
    _getSelectedItemsFromList(values) {
        var _this$_list3;
        const listSelectedItems = null === (_this$_list3 = this._list) || void 0 === _this$_list3 ? void 0 : _this$_list3.option("selectedItems");
        let selectedItems = [];
    ...
    _shouldUpdateSelectedItems() {
        ...
        if ((0, _type.isDefined)(selectedItems) && selectedItems.length !== (null === (_this$_selectedItems = this._selectedItems) || void 0 === _this$_selectedItems ? void 0 : _this$_selectedItems.length)) {
            return true
        }
        const intersection = (0, _array.getIntersection)(selectedItems, this._selectedItems);
        if (intersection.length !== (null === (_this$_selectedItems2 = this._selectedItems) || void 0 === _this$_selectedItems2 ? void 0 : _this$_selectedItems2.length)) {
            return true
        }
        return false
    }
    ...
    _createTag(value, $input, tagId, displayValue) {
        return (0, _renderer.default)("<div>").attr("id", tagId).addClass("dx-tag").data("dxTagData", value).data("dxTagDisplayValue", displayValue).insertBefore($input)
    }
    ...
    _removeTagHandler(args) {
        ...
        e.stopPropagation();
        this._saveValueChangeEvent(e);
        const $tag = (0, _renderer.default)(e.target).closest(".dx-tag");
    ...
    _setValue(value) {
        ...
        const values = (useButtons ? (null === (_this$_list4 = this._list) || void 0 === _this$_list4 ? void 0 : _this$_list4.option("selectedItemKeys")) || [] : this._getValue()).slice();
        if (valueIndex >= 0) {
        ...
        if (useButtons) {
            var _this$_list5;
            null === (_this$_list5 = this._list) || void 0 === _this$_list5 || _this$_list5.option("selectedItemKeys", values)
        } else {
    ...
    _refreshSelected() {
        var _this$_list6;
        (null === (_this$_list6 = this._list) || void 0 === _this$_list6 ? void 0 : _this$_list6.getDataSource()) && this._list.option("selectedItems", this._selectedItems)
    }
    ...
    _renderOpenedState() {
        ...
        if ("useButtons" === applyValueMode && !this.option("opened")) {
            this._refreshSelected()
        }
    }
    clear() {
