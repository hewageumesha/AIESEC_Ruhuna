...
exports.findLastVisibleExpandedItemIndex = findLastVisibleExpandedItemIndex;
...
function findLastVisibleExpandedItemIndex(items) {
    for (let i = items.length - 1; i >= 0; i -= 1) {
        const {
            collapsed: collapsed,
            visible: visible
...
function normalizePanelSize(paneRestrictions, size) {
    ...
    if (false === resizable && (0, _type.isDefined)(paneRestrictions.size)) {
...
function getNextLayout(currentLayout, delta, prevPaneIndex, paneRestrictions) {
    ...
    while (currentItemIndex >= 0 && currentItemIndex < paneRestrictions.length) {
        ...
        if (!(0 === (0, _number_comparison.compareNumbersWithPrecision)(prevSize, safeSize))) {
    ...
    if (0 === (0, _number_comparison.compareNumbersWithPrecision)(deltaApplied, 0)) {
        return currentLayout
    }
    ...
    if (!(0 === (0, _number_comparison.compareNumbersWithPrecision)(safeSize, unsafeSize))) {
        ...
        while (index >= 0 && index < paneRestrictions.length) {
            ...
            if (0 === (0, _number_comparison.compareNumbersWithPrecision)(deltaRemaining, 0)) {
                break
            }
            if (currentDelta > 0) {
                index -= 1
    ...
    if (!(0 === (0, _number_comparison.compareNumbersWithPrecision)(totalSize, 100, 2))) {
        return currentLayout
    }
    return nextLayout
}
