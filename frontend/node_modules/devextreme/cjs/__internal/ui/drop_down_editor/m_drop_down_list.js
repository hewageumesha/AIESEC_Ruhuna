/**
 * DevExtreme (cjs/__internal/ui/drop_down_editor/m_drop_down_list.js)
 * Version: 24.2.8
...
class DropDownList extends _m_drop_down_editor.default {
    ...
    _loadItem(value, cache) {
        ...
        return void 0 !== selectedItem ? (0, _deferred.Deferred)().resolve(selectedItem).promise() : this._loadValue(value)
    }
