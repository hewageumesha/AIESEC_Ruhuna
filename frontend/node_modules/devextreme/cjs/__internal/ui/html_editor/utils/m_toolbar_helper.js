/**
 * DevExtreme (cjs/__internal/ui/html_editor/utils/m_toolbar_helper.js)
 * Version: 24.2.8
...
function applyCellDimensionChanges(module, _ref12) {
    ...
    if ((0, _type.isDefined)(newWidth)) {
        ...
        const shouldUpdateNearestColumnWidth = 0 === (0, _m_table_helper.getAutoSizedElements)($table).length;
