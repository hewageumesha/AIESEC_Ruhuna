/**
 * DevExtreme (cjs/__internal/ui/text_box/m_text_editor.base.js)
 * Version: 24.2.8
...
exports.default = exports.TEXTEDITOR_INPUT_CLASS = exports.TEXTEDITOR_CLASS = void 0;
...
class TextEditorBase extends _editor.default {
    ...
    _getDefaultOptions() {
        return _extends({}, super._getDefaultOptions(), {
            ...
            text: void 0,
            displayValueFormatter: value => (0, _type.isDefined)(value) && false !== value ? value : "",
    ...
    _renderInput() {
        this._$textEditorContainer = (0, _renderer.default)("<div>").addClass("dx-texteditor-container").appendTo(this.$element());
    ...
    _renderPlaceholderMarkup() {
        ...
        const placeholderAttributes = {
            id: placeholder ? `dx-${new _guid.default}` : void 0,
    ...
    _hasFocusClass(element) {
        return super._hasFocusClass((0, _renderer.default)(element || this.$element()))
    }
