...
class Form extends _widget.default {
    ...
    _getContent() {
        ...
        return this.option("scrollingEnabled") ? (0, _renderer.default)(null === (_this$_scrollable = this._scrollable) || void 0 === _this$_scrollable ? void 0 : _this$_scrollable.content()) : this.$element()
    }
