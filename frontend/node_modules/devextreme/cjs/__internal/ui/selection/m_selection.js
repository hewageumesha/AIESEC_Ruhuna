...
class Selection {
    constructor(options) {
        ...
        this._selectionStrategy = this.options.deferred ? new _m_selectionStrategy.default(this.options) : new _m_selectionStrategy2.default(this.options);
    ...
    _getDefaultOptions() {
        return {
            ...
            key: _common.noop,
            keyOf: item => item,
            load: () => (0, _deferred.Deferred)().resolve([]),
            totalCount: () => -1,
