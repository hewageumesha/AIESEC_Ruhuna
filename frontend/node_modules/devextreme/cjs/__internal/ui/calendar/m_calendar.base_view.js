...
class BaseView extends _widget.default {
    ...
    _getSingleModeAriaLabel() {
        ...
        const formattedDate = _date.default.format(value, "date");
    ...
    _getRangeModeAriaLabel() {
        ...
        const formattedStartDate = _date.default.format(startDate, "date");
        const formattedEndDate = _date.default.format(endDate, "date");
    ...
    _getMultipleRangesText() {
        ...
        const ranges = _date2.default.getRangesByDates(value.map((date => new Date(date))));
        if (ranges.length > 2) {
    ...
    _getRangeText(range) {
        ...
        const formattedStartDate = _date.default.format(startDate, "date");
        const formattedEndDate = _date.default.format(endDate, "date");
        const selectedDatesText = startDate && endDate ? _message.default.format("dxCalendar-selectedMultipleDateRange", formattedStartDate, formattedEndDate) : formattedStartDate;
    ...
    _renderEvents() {
        ...
        if (selectionMode !== SELECTION_MODE.single) {
            ...
            _events_engine.default.on(this._$table, CALENDAR_DXCLICK_EVENT_NAME, ".dx-calendar-week-number-cell", (e => {
                ...
                const rowDates = [..._date2.default.getDatesOfInterval(firstDateInRow, lastDateInRow, 864e5), lastDateInRow];
    ...
    _getFirstAvailableDate() {
        ...
        date = _date2.default.getViewFirstCellDate(this._getViewName(), date);
