/**
 * DevExtreme (cjs/__internal/ui/context_menu/m_context_menu.js)
 * Version: 24.2.8
...
class ContextMenu extends _m_menu_base.default {
    ...
    preventShowingDefaultContextMenuAboveOverlay() {
        ...
        _events_engine.default.off($itemContainer, eventName, ".dx-submenu");
        _events_engine.default.on($itemContainer, eventName, ".dx-submenu", (e => {
            e.stopPropagation();
            e.preventDefault();
            _events_engine.default.off($itemContainer, eventName, ".dx-submenu")
        }))
    ...
    _getActiveItemsContainer(target) {
        return (0, _renderer.default)(target).closest(".dx-menu-items-container")
    }
    _getItemsContainers() {
        return this._overlay.$content().find(".dx-menu-items-container")
    }
    _searchActiveItem(target) {
        return (0, _renderer.default)(target).closest(".dx-menu-item").eq(0)
    }
    ...
    _getSubmenuBorderWidth() {
        return (0, _themes.isGeneric)((0, _themes.current)()) ? 1 : 0
    }
    _showSubmenu($item) {
    ...
    _updateSubmenuVisibilityOnClick(actionArgs) {
        ...
        if (0 === $submenu.length) {
            const $prevSubmenu = (0, _renderer.default)($itemElement.parents(".dx-submenu")[0]);
    ...
    _stopAnimate($container) {
        _animation.fx.stop($container, true)
    }
    ...
    _show(event) {
        ...
        if (position) {
            ...
            const $subMenu = (0, _renderer.default)(this._overlay.content()).children(".dx-submenu");
            ...
            this._overlay.option({
                ...
                maxHeight: () => {
                    ...
                    return (0, _size.getOuterHeight)($content) + 2 * borderWidth
                },
                position: position
            });
            if ($subMenu.length) {
            ...
            if ((null === event || void 0 === event || null === (_event$originalEvent = event.originalEvent) || void 0 === _event$originalEvent ? void 0 : _event$originalEvent.type) === _hold.default.name) {
