...
class SpeedDialMainItem extends _m_speed_dial_item.default {
    ...
    _clickHandler() {
        ...
        if (null !== (_config$floatingActio = (0, _config.default)().floatingActionButtonConfig) && void 0 !== _config$floatingActio && _config$floatingActio.shading) {
    ...
    _renderActions() {
        ...
        if (null !== (_this$_actionItems = this._actionItems) && void 0 !== _this$_actionItems && _this$_actionItems.length) {
