...
class ValidationSummary extends _m_collection_widget.default {
    _getDefaultOptions() {
    ...
    _initGroupRegistration() {
        ...
        const group = validationGroup || _m_validation_engine.default.findGroup($element, this._modelByElement($element));
