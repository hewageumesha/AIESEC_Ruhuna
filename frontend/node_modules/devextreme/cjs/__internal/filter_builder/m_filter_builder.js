...
class FilterBuilder extends _ui3.default {
    ...
    _createConditionElement(condition, parent, groupLevel) {
        return (0, _renderer.default)("<div>").addClass("dx-filterbuilder-group").append(this._createConditionItem(condition, parent, groupLevel)).attr("role", "group")
    }
    ...
    _createGroupElement(criteria, parent, groupLevel) {
        ...
        const $groupContent = (0, _renderer.default)("<div>").addClass("dx-filterbuilder-group-content").attr("id", `${$guid}`);
    ...
    _createPopupWithTreeView(options, $container) {
        ...
        this._createComponent($popup, _ui.default, {
            ...
            maxHeight: () => (0, _m_utils.getElementMaxHeightByWindow)(options.menu.position.of),
            visible: true,
