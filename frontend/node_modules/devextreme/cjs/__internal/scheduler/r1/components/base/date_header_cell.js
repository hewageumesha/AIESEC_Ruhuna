...
var _index = require("../../../../scheduler/r1/components/templates/index");
...
class DateHeaderCell extends _inferno2.BaseInfernoComponent {
    render() {
        ...
        const children = useTemplate ? (0, _inferno.createFragment)([isTimeCellTemplate && (0, _inferno.createComponentVNode)(2, _index.PublicTemplate, {
        ...
        }), !isTimeCellTemplate && (0, _inferno.createComponentVNode)(2, _index.PublicTemplate, {
