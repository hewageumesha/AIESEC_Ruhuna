...
class SchedulerWorkSpace extends _m_widget_observer.default {
    ...
    _createCrossScrollingConfig(_ref3) {
        let {
            onScroll: onScroll
        } = _ref3;
        return {
    ...
    _updateSelectedCellDataOption(selectedCellData, $nextFocusedCell) {
        const correctedSelectedCellData = selectedCellData.map((_ref5 => {
            let {
                startDate: startDate,
                endDate: endDate,
                allDay: allDay,
    ...
    _createDragBehaviorBase(targetElement, rootElement, options) {
        ...
        }), (() => this.getDroppableCell()), (() => this._getDateTables()), (() => this.removeDroppableCellClass()), (() => this.getCellWidth()), options))
    }
    ...
    _initWorkSpaceUnits() {
        ...
        this._$allDayTable = (0, _renderer.default)("<table>").attr("aria-hidden", true);
        ...
        this._$timePanel = (0, _renderer.default)("<table>").addClass(_m_classes.TIME_PANEL_CLASS).attr("aria-hidden", true);
    ...
    _createWorkSpaceStaticElements() {
        ...
        this.$element().append(this._$fixedContainer).append(this._$headerPanelContainer).append(this._dateTableScrollable.$element())
    }
    ...
    _removeAllDayElements() {
        var _this$_$allDayTable, _this$_$allDayTitle;
        null === (_this$_$allDayTable = this._$allDayTable) || void 0 === _this$_$allDayTable || _this$_$allDayTable.remove();
        null === (_this$_$allDayTitle = this._$allDayTitle) || void 0 === _this$_$allDayTitle || _this$_$allDayTitle.remove()
    }
    _cleanView() {
        var _this$_shader;
        this.cache.clear();
        ...
        if (!this.isRenovatedRender()) {
            var _this$_$allDayTable2, _this$_$sidebarTable;
            this._$thead.empty();
            this._$dateTable.empty();
            this._$timePanel.empty();
            this._$groupTable.empty();
            null === (_this$_$allDayTable2 = this._$allDayTable) || void 0 === _this$_$allDayTable2 || _this$_$allDayTable2.empty();
    ...
    _cleanTableWidths() {
        var _this$_$allDayTable3;
        this._$headerPanel.css("width", "");
        this._$dateTable.css("width", "");
        null === (_this$_$allDayTable3 = this._$allDayTable) || void 0 === _this$_$allDayTable3 || _this$_$allDayTable3.css("width", "")
    }
