...
exports.setResourceToAppointment = exports.reduceResourcesTree = exports.loadResources = exports.isResourceMultiple = exports.groupAppointmentsByResourcesCore = exports.groupAppointmentsByResources = exports.getWrappedDataSource = exports.getTextExpr = exports.getResourcesDataByGroups = exports.getResourceTreeLeaves = exports.getResourceColor = exports.getResourceByField = exports.getPathToLeaf = exports.getPaintedResources = exports.getOrLoadResourceItem = exports.getNormalizedResources = exports.getIdExpr = exports.getGroupsObjectFromGroupsArray = exports.getFieldExpr = exports.getDataAccessors = exports.getCellGroups = exports.getAppointmentColor = exports.getAllGroups = exports.filterResources = exports.createResourcesTree = exports.createResourceEditorModel = exports.createReducedResourcesTree = exports.createExpressions = void 0;
...
const getIdExpr = resource => resource.valueExpr || "id";
exports.getIdExpr = getIdExpr;
const getTextExpr = resource => resource.displayExpr || "text";
exports.getTextExpr = getTextExpr;
...
const reduceResourcesTree = (getDataAccessors, tree, existingAppointments, _result) => {
    ...
    tree.forEach(((node, index) => {
        ...
        if (ok && null !== (_node$children = node.children) && void 0 !== _node$children && _node$children.length) {
...
const getTransformedResourceData = (resource, data) => {
    const valueGetter = (0, _data.compileGetter)(getIdExpr(resource));
    const displayGetter = (0, _data.compileGetter)(getTextExpr(resource));
