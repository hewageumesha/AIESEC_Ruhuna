/**
 * DevExtreme (cjs/__internal/grids/grid_core/sticky_columns/utils.js)
 * Version: 24.2.8
...
const needToDisableStickyColumn = function(that, column) {
...
const getStickyOffset = function(that, columns, widths, columnIndex, offsets) {
    const result = {};
    const column = columns[columnIndex];
    if (column) {
...
const needToRemoveColumnBorderCore = function(that, column, visibleColumns, rowIndex) {
    ...
    return !!(null !== prevColumn && void 0 !== prevColumn && prevColumn.fixed) && !needToDisableStickyColumn(that, prevColumn) && (!column.fixed || columnFixedPosition === _const2.StickyPosition.Sticky || prevColumnFixedPosition === _const2.StickyPosition.Sticky)
};
const needToRemoveColumnBorder = function(that, column, rowIndex) {
...
const isFirstFixedColumn = function(that, column, rowIndex) {
    let onlyWithinBandColumn = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : false;
...
const isLastFixedColumn = function(that, column, rowIndex) {
    let onlyWithinBandColumn = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : false;
    let fixedPosition = arguments.length > 4 ? arguments[4] : void 0;
