...
const columnHeadersView = Base => class extends((0, _m_header_filter_core.headerFilterMixin)(Base)) {
...
const headerPanel = Base => class extends((0, _m_header_filter_core.headerFilterMixin)(Base)) {
