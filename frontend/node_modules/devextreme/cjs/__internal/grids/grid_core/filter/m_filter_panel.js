...
class FilterPanelView extends _m_modules.default.View {
    ...
    _getRemoveButtonElement() {
        ...
        const $element = (0, _renderer.default)("<div>").addClass(that.addWidgetPrefix("filter-panel-clear-filter")).text(that.option("filterPanel.texts.clearFilter"));
