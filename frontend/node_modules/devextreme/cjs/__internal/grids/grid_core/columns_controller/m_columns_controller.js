...
class ColumnsController extends _m_modules.default.Controller {
    ...
    _updateRequireResize(args) {
        ...
        if ("width" === args.fullName.replace(_const2.COLUMN_OPTION_REGEXP, "") && component._updateLockCount) {
    ...
    _updateChanges(dataSource, parameters) {
        ...
        if (this._dataController && !_m_utils.default.equalFilterParameters(parameters.filtering, this._dataController.getCombinedFilter(), langParams)) {
    ...
    updateSortingGrouping(dataSource, fromDataSource) {
        ...
        if (dataSource) {
            ...
            const sortParameters = _m_utils.default.normalizeSortingInfo(dataSource.sort());
            ...
            const sortingChanged = !_m_utils.default.equalSortParameters(sortParameters, columnsSortParameters);
        ...
        if (dataField) {
            if ((0, _type.isString)(dataField)) {
                ...
                calculatedColumnOptions = {
                    caption: _m_inflector.default.captionize(dataField),
