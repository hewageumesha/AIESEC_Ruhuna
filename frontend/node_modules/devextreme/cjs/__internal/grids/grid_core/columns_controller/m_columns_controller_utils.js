...
const columnOptionCore = function(that, column, optionName, value, notFireEvent) {
    ...
    if (!(0, _common.equalByValue)(prevValue, value, {
        ...
        if (!(0, _type.isDefined)(prevValue) && !(0, _type.isDefined)(value) && 0 !== optionName.indexOf("buffer") && false !== notFireEvent) {
            notFireEvent = true
        }
        if (!notFireEvent) {
            if (!_const3.USER_STATE_FIELD_NAMES.includes(optionName) && "visibleWidth" !== optionName) {
...
const isFirstOrLastColumn = function(that, targetColumn, rowIndex) {
    let onlyWithinBandColumn = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : false;
    let isLast = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : false;
    let fixedPosition = arguments.length > 5 ? arguments[5] : void 0;
