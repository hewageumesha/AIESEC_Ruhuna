...
class KeyboardNavigationController extends _m_modules.default.ViewController {
    ...
    dispose() {
        ...
        _short.keyboard.off(this._rowsViewKeyDownListener);
        _short.keyboard.off(this._columnHeadersViewKeyDownListener);
    ...
    subscribeToColumnHeadersViewKeyDownEvent() {
        ...
        this._columnHeadersViewKeyDownListener = _short.keyboard.on($columnHeadersView, null, (e => this._columnHeadersViewKeyDownHandler(e)))
    }
    ...
    subscribeToRowsViewKeyDownEvent() {
        const $rowsView = this._getRowsViewElement();
        this._rowsViewKeyDownListener = _short.keyboard.on($rowsView, null, (e => this._rowsViewKeyDownHandler(e)))
    }
    ...
    _targetCellTabHandler(eventArgs, direction) {
        ...
        if (!(0, _m_keyboard_navigation_utils.isEditorCell)(this, $cell) && null !== $lastInteractiveElement && void 0 !== $lastInteractiveElement && $lastInteractiveElement.length && eventTarget !== $lastInteractiveElement.get(0)) {
            isOriginalHandlerRequired = true
        } else {
    ...
    _updateFocusedCellPositionByTarget(target) {
        ...
        if ("row" === elementType && (0, _type.isDefined)(null === (_this$_focusedCellPos2 = this._focusedCellPosition) || void 0 === _this$_focusedCellPos2 ? void 0 : _this$_focusedCellPos2.columnIndex)) {
