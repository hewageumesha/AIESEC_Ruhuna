...
const validatingEditorFactoryExtender = Base => class extends Base {
    ...
    getRevertButton() {
        ...
        return (0, _renderer.default)(null === (_this$_revertTooltip3 = this._revertTooltip) || void 0 === _this$_revertTooltip3 ? void 0 : _this$_revertTooltip3.element())
    }
...
const validatingRowsViewExtender = Base => class extends Base {
    updateFreeSpaceRowHeight($table) {
        ...
        if ($tooltipContent && $tooltipContent.length) {
            ...
            if ($freeSpaceRowElement && 1 === $rowElements.length && (!$freeSpaceRowElement.is(":visible") || (0, _size.getOuterHeight)($tooltipContent) > (0, _size.getOuterHeight)($freeSpaceRowElement)) && rowElementsHasFocusInside) {
