...
const calculateOperationTypes = function(loadOptions, lastLoadOptions, isFullReload) {
    ...
    if (lastLoadOptions) {
        operationTypes = {
            ...
            filtering: !_m_utils.default.equalFilterParameters(loadOptions.filter, lastLoadOptions.filter, loadOptions.langParams),
...
const executeTask = function(action, timeout) {
    if ((0, _type.isDefined)(timeout)) {
        _m_common.default.executeAsync(action, timeout)
    } else {
        action()
    }
};
