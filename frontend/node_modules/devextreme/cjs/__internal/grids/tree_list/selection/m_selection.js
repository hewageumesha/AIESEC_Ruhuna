...
const data = Base => class extends((0, _m_selection.dataSelectionExtenderMixin)(Base)) {
...
const columnHeadersView = Base => class extends((0, _m_selection.columnHeadersSelectionExtenderMixin)(Base)) {
...
const rowsView = Base => class extends((0, _m_selection.rowsViewSelectionExtenderMixin)(Base)) {
