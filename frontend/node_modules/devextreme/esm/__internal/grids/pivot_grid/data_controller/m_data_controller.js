...
const DataController = Class.inherit(function() {
    function formatCellValue(value, dataField, errorText) {
        return "#N/A" === value ? errorText : formatValue(value, dataField)
    }
    const createHeaderInfo = function() {
        const addInfoItem = function(info, options) {
            ...
            const itemInfo = function(headerItem, breadth, isHorizontal, isTree) {
                ...
                if (isTree && null !== (_headerItem$children = headerItem.children) && void 0 !== _headerItem$children && _headerItem$children.length && !headerItem.children[0].isMetric) {
                    infoItem.width = null;
        ...
        const getViewHeaderItems = function(headerItems, headerDescriptions, cellDescriptions, depthSize, options) {
            ...
            const viewHeaderItems = function(headerItems, headerDescriptions) {
                const headerDescriptionsCount = (null === headerDescriptions || void 0 === headerDescriptions ? void 0 : headerDescriptions.length) || 0;
                const childrenStack = [];
                ...
                when(foreachTreeAsync(viewHeaderItems, (items => {
                    ...
                    if (cellDescriptionsCount > 1) {
                                ...
                                if (!item.children || 0 === item.children.length) {
                                    ...
                                    for (i = 0; i < cellDescriptions.length; i += 1) {
                                        ...
                                        item.children.push({
                                            ...
                                            dataIndex: i,
                                            isMetric: true,
                                            isEmpty: null === (_item$isEmpty = item.isEmpty) || void 0 === _item$isEmpty ? void 0 : _item$isEmpty[i]
                                        })
                                    }
                                }
                            }))
                        ...
                        foreachTree([{
                            ...
                            if (null !== (_isEmpty = isEmpty) && void 0 !== _isEmpty && _isEmpty.length) {
                    ...
                    when(foreachTreeAsync(viewHeaderItems, (items => {
                        ...
                        item.isLast = !(null !== (_item$children = item.children) && void 0 !== _item$children && _item$children.length);
                        if (item.isLast) {
        ...
        const removeEmptyParent = function(items, index) {
            ...
            if (!items[index].children.length && null !== parent && void 0 !== parent && parent.children) {
    ...
    const members = {
        ...
        subscribeToWindowScrollEvents($element) {
            ...
            null === (_this$_rowsScrollCont = this._rowsScrollController) || void 0 === _this$_rowsScrollCont || _this$_rowsScrollCont.subscribeToWindowScrollEvents($element)
        },
        updateWindowScrollPosition(position) {
            var _this$_rowsScrollCont2;
            null === (_this$_rowsScrollCont2 = this._rowsScrollController) || void 0 === _this$_rowsScrollCont2 || _this$_rowsScrollCont2.scrollTo(position)
        },
        ...
        _handleFieldsPrepared(e) {
            ...
            null === (_this$_options$onFiel = (_this$_options = this._options).onFieldsPrepared) || void 0 === _this$_options$onFiel || _this$_options$onFiel.call(_this$_options, e)
        },
        ...
        _update() {
            ...
            const rowOptions = extend({}, commonOptions, {
            ...
            const columnOptions = extend({}, commonOptions, {
        ...
        getRowsInfo(getAllData) {
            ...
            let rowspan;
            const isOnePredefinedRow = 1 === rowsInfo.length && (!rowsInfo[0].type || "GT" === rowsInfo[0].type);
            if (scrollController && !getAllData && !isOnePredefinedRow) {
                ...
                const isRowDataFieldArea = "row" === this._options.dataFieldArea;
                const newRowsInfo = [];
                let maxDepth = 1;
        ...
        totalColumnCount() {
            ...
            let count = 0;
            if (null !== (_this$_columnsInfo = this._columnsInfo) && void 0 !== _this$_columnsInfo && _this$_columnsInfo.length) {
        ...
        dispose() {
            ...
            null === (_that$_columnsScrollC = that._columnsScrollController) || void 0 === _that$_columnsScrollC || _that$_columnsScrollC.dispose();
            null === (_that$_rowsScrollCont = that._rowsScrollController) || void 0 === _that$_rowsScrollCont || _that$_rowsScrollCont.dispose();
