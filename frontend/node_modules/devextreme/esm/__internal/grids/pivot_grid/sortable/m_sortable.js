...
const Sortable = DOMComponent.inherit({
    ...
    _detachEventHandlers() {
        ...
        eventsEngine.off(this._getEventListener(), addNamespace(dragEventsString, "dxSortable"), void 0)
    },
    ...
    _attachEventHandlers() {
        ...
        if (that.option("allowDragging")) {
            ...
            eventsEngine.on($eventListener, addNamespace(dragEventStart, "dxSortable"), itemSelector, (e => {
            ...
            eventsEngine.on($eventListener, addNamespace(dragEventMove, "dxSortable"), (e => {
                let $item;
                let $lastItem;
                let $prevItem;
                if (!$sourceItem) {
            ...
            eventsEngine.on($eventListener, addNamespace(dragEventEnd, "dxSortable"), (() => {
                disposeScrollWrapper();
                if (!$sourceItem) {
                    return
                }
