...
class TagBox extends SelectBox {
    ...
    _shouldUpdateSelectedItems() {
        ...
        if (isDefined(selectedItems) && selectedItems.length !== (null === (_this$_selectedItems = this._selectedItems) || void 0 === _this$_selectedItems ? void 0 : _this$_selectedItems.length)) {
            return true
        }
