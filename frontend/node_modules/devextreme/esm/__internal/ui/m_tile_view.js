/**
 * DevExtreme (esm/__internal/ui/m_tile_view.js)
 * Version: 24.2.8
...
class TileView extends CollectionWidget {
    ...
    _renderContentSize(config, itemMargin) {
        ...
        if (hasWindow()) {
            ...
            const elementSize = ("width" === mainDimension ? getWidth : getHeight)(this.$element());
    ...
    _scrollToItem($itemElement) {
        ...
        const config = this._config;
        const outerMainGetter = "width" === config.mainDimension ? getOuterWidth : getOuterHeight;
        const itemMargin = this.option("itemMargin");
