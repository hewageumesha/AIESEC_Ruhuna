/**
 * DevExtreme (esm/__internal/ui/m_file_uploader.js)
 * Version: 24.2.8
...
class FileUploader extends Editor {
    ...
    _createFiles() {
        ...
        if (this._files && (0 === (null === value || void 0 === value ? void 0 : value.length) || !this._shouldFileListBeExtended())) {
        ...
        each(null === value || void 0 === value ? void 0 : value.slice(this._files.length), ((_, value) => {
    ...
    _validateFileExtension(file) {
        ...
        if (0 !== (null === accept || void 0 === accept ? void 0 : accept.length) && !this._isFileTypeAllowed(file.value, allowedTypes)) {
            return false
        }
        if (0 === (null === allowedExtensions || void 0 === allowedExtensions ? void 0 : allowedExtensions.length)) {
            return true
        }
