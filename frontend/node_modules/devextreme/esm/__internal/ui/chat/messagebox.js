...
export const TYPING_END_DELAY = 2e3;
...
class MessageBox extends DOMComponent {
    ...
    _initMarkup() {
        $(this.element()).addClass("dx-chat-messagebox");
        super._initMarkup();
    ...
    _renderTextArea() {
        ...
        const $textArea = $("<div>").addClass("dx-chat-messagebox-textarea").appendTo(this.element());
    ...
    _renderButton() {
        ...
        const $button = $("<div>").addClass("dx-chat-messagebox-button").appendTo(this.element());
