...
class HtmlEditor extends Editor {
    ...
    _convertToHtml(value) {
        ...
        const result = isFunction(null === (_this$_htmlConverter = this._htmlConverter) || void 0 === _this$_htmlConverter ? void 0 : _this$_htmlConverter.toHtml) ? String(this._htmlConverter.toHtml(value ?? "") ?? "") : value;
        return result
    }
    _convertFromHtml(value) {
        var _this$_htmlConverter2;
        const result = isFunction(null === (_this$_htmlConverter2 = this._htmlConverter) || void 0 === _this$_htmlConverter2 ? void 0 : _this$_htmlConverter2.fromHtml) ? String(this._htmlConverter.fromHtml(value) ?? "") : value;
        return result
    }
