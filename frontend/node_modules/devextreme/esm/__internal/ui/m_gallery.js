...
class Gallery extends CollectionWidget {
    ...
    _init() {
        super._init();
        this._activeStateUnit = ".dx-gallery-item";
    ...
    _renderItemPositions() {
        ...
        this._itemElements().each((function(index) {
            let realIndex = index;
            const isLoopItem = $(this).hasClass("dx-gallery-item-loop");
    ...
    _renderIndicator() {
        ...
        const indicator = this._$indicator = $("<div>").addClass("dx-gallery-indicator").appendTo(this._$wrapper);
        const {
            indicatorEnabled: indicatorEnabled
        } = this.option();
        for (let i = 0; i < this._pagesCount(); i++) {
            const $indicatorItem = $("<div>").addClass("dx-gallery-indicator-item").appendTo(indicator);
            if (indicatorEnabled) {
