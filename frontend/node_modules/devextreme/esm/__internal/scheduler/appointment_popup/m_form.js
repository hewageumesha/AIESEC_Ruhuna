...
export class AppointmentForm {
    ...
    scheduleTimezoneEditorDataSourceUpdate(editorName, dataSource, selectedTimezoneLabel, date) {
        timeZoneUtils.getTimeZoneLabelsAsyncBatch(date).catch((() => [])).then((async timezones => {
    ...
    setupTimezoneEditorDataSource(editorName, selectedTimezoneId, date) {
        const selectedTimezoneLabel = selectedTimezoneId ? timeZoneUtils.getTimeZoneLabel(selectedTimezoneId, date) : null;
        const dataSource = new DataSource(_extends({}, DEFAULT_TIMEZONE_EDITOR_DATA_SOURCE_OPTIONS, {
