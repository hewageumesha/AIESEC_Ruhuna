...
export default {
    ...
    getMinValue: function(noErrorBar) {
        ...
        if (errorBarOptions && !noErrorBar) {
            ...
            const lowValue = "high" !== displayMode && _isDefined(this.lowError) ? this.lowError : this.value;
            const highValue = "low" !== displayMode && _isDefined(this.highError) ? this.highError : this.value;
