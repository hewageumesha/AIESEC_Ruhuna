...
export default _extend({}, symbolPoint, {
    ...
    _correctLabelCoord: function(coord, moveLabelsFromCenter) {
        ...
        const angleOfPoint = _normalizeAngle(this.middleAngle);
    ...
    _getLabelConnector: function() {
        ...
        const angleFunctions = _getCosAndSin(_round(this.middleAngle));
        return {
    ...
    getTooltipParams: function() {
        const angleFunctions = _getCosAndSin(this.middleAngle);
