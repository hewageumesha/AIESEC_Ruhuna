    ...
    getBoundRange: function() {
        ...
        if (!valRange.isEmpty() && !argRange.isEmpty()) {
            ...
            if (isNumeric(rangeVisibleSizeY)) {
                valRange.maxVisible = isDefined(valRange.maxVisible) ? valRange.maxVisible + rangeVisibleSizeY * maxIndent : void 0;
                valRange.minVisible = isDefined(valRange.minVisible) ? valRange.minVisible - rangeVisibleSizeY * minIndent : void 0
            }
