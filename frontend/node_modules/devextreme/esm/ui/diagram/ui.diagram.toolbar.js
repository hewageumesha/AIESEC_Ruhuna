...
class DiagramToolbar extends DiagramPanel {
    ...
    _createMainElement() {
        return $("<div>").addClass("dx-diagram-toolbar").appendTo(this._$element)
    }
    _getCommands() {
        ...
        if ("separator" === item.widget) {
            return {
                template: (data, index, element) => {
                    $(element).addClass("dx-diagram-toolbar-separator")
                },
                menuItemTemplate: (data, index, element) => {
                    $(element).addClass("dx-diagram-toolbar-menu-separator")
                }
            }
        }
        return {
            ...
            options: {
                onOpened: () => {
                    if (this.option("isMobileView")) {
                        $("body").addClass("dx-diagram-mobile-toolbar-color-box-opened")
                    }
                },
                onClosed: () => {
                    $("body").removeClass("dx-diagram-mobile-toolbar-color-box-opened")
                }
            }
        });
        return options
