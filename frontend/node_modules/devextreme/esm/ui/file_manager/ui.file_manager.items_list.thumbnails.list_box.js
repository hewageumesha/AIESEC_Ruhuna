...
const FILE_MANAGER_THUMBNAILS_LIST_BOX_HOLD_EVENT_NAME = addNamespace(holdEvent.name, "dxFileManagerThumbnailsListBox");
class FileManagerThumbnailListBox extends CollectionWidget {
    ...
    _renderItemsContainer() {
        if (!this._$itemContainer) {
            this._$itemContainer = $("<div>").addClass("dx-filemanager-thumbnails-container").appendTo(this._$scrollView)
        }
    }
    _render() {
        super._render();
    ...
    _getDefaultItemTemplate(fileItemInfo, $itemElement) {
        ...
        const $itemSpacer = $("<div>").addClass("dx-filemanager-thumbnails-item-spacer");
        const $itemName = $("<div>").addClass("dx-filemanager-thumbnails-item-name").text(fileItemInfo.fileItem.name);
