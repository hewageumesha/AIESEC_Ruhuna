...
export default class dxChart extends BaseChart<dxChartOptions> {
    ...
    /**
     * Resets the visual ranges of both axes to the data range or the whole range if it is within the data range. [note] resetVisualRange() does not support multi-axis charts.
     */
