...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./browser-EEDXS5MH.js").then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var RealtimeClient = class {
  ...
  connect() {
    ...
    import("./browser-FQ2UBZAL.js").then(({ default: WS }) => {
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-EEDXS5MH.js")).Response;
  }
  return Response;
});
