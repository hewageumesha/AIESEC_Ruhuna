...
public class BirthdayEmailService {
    ...
    public void sendFlyerEmail(BirthdayDTO person) throws MessagingException {
        String[] to = {
        ...
        "<a href='" + person.getProfilePicture() + "' target='_blank' style='color:#4CAF50; text-decoration:none; font-size:18px;'>View Photo</a>" +
