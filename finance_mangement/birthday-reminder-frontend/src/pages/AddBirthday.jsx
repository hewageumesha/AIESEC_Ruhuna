...
const AddBirthday = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center py-10 px-4">
      <form
      ...
      >
        ...
        {["name", "date", "role", "email", "photo"].map((field) => (
